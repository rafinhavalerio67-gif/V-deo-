...
S.Transparency = 0.75
S.Thickness = 1
S.Parent = ColorButton
Connect(ColorButton.MouseButton1Click:Connect(function()
OnColor(Color, Name)
Preview.BackgroundColor3 = Color
Picker:Destroy()
if ActivePicker == Picker then
ActivePicker = nil
end
end))
end
ActivePicker = Picker
Connect(ClosePicker.MouseButton1Click:Connect(function()
Picker:Destroy()
if ActivePicker == Picker then
ActivePicker = nil
end
...
ConfigStatus.Size = UDim2.new(1, -20, 0, 55)
ConfigStatus.Position = UDim2.fromOffset(10, 178)
ConfigStatus.BackgroundTransparency = 1
ConfigStatus.Text = "FOV: ajustável somente na aba AIM\nESP: 5000 studs"
...
ConfigStatus.Parent = ConfigPage
RegisterOptionLabel(ConfigStatus)
local Pages = {
AIM = AimPage,
ESP = ESPPage,
CONFIG = ConfigPage,
